    ...
    return (
        <Item>
            {Data.map((email) => (
                ...
                style={{
                  cursor: 'pointer',
                  color: selected === email ? '#007bff' : '#000',
                  transition: 'color 0.3s, font-weight 0.3s, background-color 0.3s, border 0.3s',
                  border: selected === email ? '2px solid #007bff' : '2px solid transparent',
                  backgroundColor: selected === email ? '#e6f2ff' : 'transparent',
                  ...
                  fontSize: '0.875rem',  // Reduced font size (smaller than the default)
                }}
              >
                {email}
              </Typography>
